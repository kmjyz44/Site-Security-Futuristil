...
export default function AdminDashboard() {
  ...
  const menuItems = [
    ...
    { path: '/admin/sections', icon: Image, label: 'Розділи' },
    { path: '/admin/messages', icon: MessageSquare, label: 'Повідомлення', badge: unreadCount },
    { path: '/admin/email', icon: Mail, label: 'Email' },
    { path: '/admin/chatbot', icon: Bot, label: 'Чатбот' },
  ];
      ...
      <aside className={`${
        ...
        <div className="p-4 border-t border-neon-cyan/20">
          ...
          >
            ...
            {sidebarOpen && <span className="font-rajdhani font-medium">Вийти</span>}
          </button>
        </div>
      </aside>
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-white/60 font-rajdhani">Управління контентом сайту</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-card p-6">
          ...
          <p className="text-white/60 font-rajdhani">Повідомлень</p>
        </div>

        <div className="glass-card p-6">
          <Image className="w-12 h-12 text-neon-purple mb-4" />
          <h3 className="text-3xl font-bold text-white mb-2">{stats.sections}</h3>
          <p className="text-white/60 font-rajdhani">Розділів</p>
        </div>

        <div className="glass-card p-6">
          <Settings className="w-12 h-12 text-neon-cyan mb-4" />
          <h3 className="text-xl font-bold text-white mb-2">Система</h3>
          <p className="text-green-400 font-rajdhani">Активна</p>
        </div>
      </div>
      ...
      <div className="glass-card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <h3 className="font-semibold text-white mb-1">Редагувати Контент</h3>
            <p className="text-sm text-white/60 font-rajdhani">Змінити тексти та контакти</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-semibold text-white mb-1">Керувати Розділами</h3>
            <p className="text-sm text-white/60 font-rajdhani">Додати/змінити послуги</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-semibold text-white mb-1">Налаштувати Email</h3>
            <p className="text-sm text-white/60 font-rajdhani">Конфігурація пошти</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-semibold text-white mb-1">Налаштувати Чатбот</h3>
            <p className="text-sm text-white/60 font-rajdhani">Підготовка до інтеграції</p>
          </Link>
        </div>
      </div>
    </div>
