    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/60 font-rajdhani">Підготовка місця для інтеграції чатбота</p>
        </div>
        <button
          onClick={handleSave}
          disabled={loading}
      ...
      <div className="glass-card p-6 space-y-6">
        ...
        <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-white font-orbitron">Активувати Чатбот</h3>
              <p className="text-sm text-white/60 font-rajdhani">Увімкнення/Вимкнення віджета</p>
            </div>
          </div>
          <button
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Введіть повідомлення привітання..."
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div className="font-semibold font-rajdhani">Правий Низ</div>
            ...
            >
              <div className="font-semibold font-rajdhani">Лівий Низ</div>
        ...
        <div className="p-4 bg-neon-purple/10 border border-neon-purple/30 rounded-lg">
          ...
          <p className="text-sm text-white/70 font-rajdhani">
            Ця сторінка підготовлена для майбутньої інтеграції чатбота. 
            Ви можете налаштувати основні параметри, які будуть використані після підключення чатбота.
          </p>
        </div>
        ...
        {settings.enabled && (
          <div className="p-6 bg-white/5 rounded-lg border border-white/10">
            <h4 className="font-semibold text-white mb-4 font-orbitron">Попередній перегляд</h4>
