...
class SiteContent(BaseModel):
    ...
    hero_subtitle: str = "Професійні системи безпеки та ремонтні послуги"
    about_text: str = "Ми надаємо найкращі послуги"
...
class ChatbotSettings(BaseModel):
    ...
    welcome_message: str = "Вітаємо! Чим можемо допомогти?"
...
async def contact_form(message: ContactMessage):
    ...
    if email_settings:
        ...
        <p><strong>Телефон:</strong> {message.phone or 'Не вказано'}</p>
...
async def startup():
    ...
    if count == 0:
        default_sections = [
            {"id": str(uuid.uuid4()), "title": "Системи Безпеки", "description": "Професійна установка систем безпеки", "image": "/images/service-security-system.jpg", "icon": "shield", "order": 1, "visible": True},
            {"id": str(uuid.uuid4()), "title": "Відеоспостереження", "description": "Камери високої якості", "image": "/images/service-cameras.jpg", "icon": "camera", "order": 2, "visible": True},
            {"id": str(uuid.uuid4()), "title": "Електромонтаж", "description": "Електричні роботи будь-якої складності", "image": "/images/service-electrical.jpg", "icon": "zap", "order": 3, "visible": True},
            {"id": str(uuid.uuid4()), "title": "Розумний Дім", "description": "Автоматизація та управління", "image": "/images/service-automation.jpg", "icon": "home", "order": 4, "visible": True},
            {"id": str(uuid.uuid4()), "title": "Замки", "description": "Сучасні системи контролю доступу", "image": "/images/service-locks.jpg", "icon": "lock", "order": 5, "visible": True},
            {"id": str(uuid.uuid4()), "title": "Монтаж ТВ", "description": "Професійний монтаж телевізорів", "image": "/images/service-tv.jpg", "icon": "tv", "order": 6, "visible": True},
        ]
